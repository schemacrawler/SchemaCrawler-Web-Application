...
- Do one of the steps below to start the web application locally on your system
  ...
  - Start application from the jar file, run  
	  `java -jar target/schemacrawler-webapp-16.16.9.2.jar`
...
You can use the [SchemaCrawler Web Application as a REST API](https://rapidapi.com/sualeh/api/schemacrawler-web-application1/). The specifications are on [Swagger Hub](https://app.swaggerhub.com/apis/sualeh/schemacrawler-web-application/16.16.9.2). 
